    ...
    return (
            <div className="tarea">
                ...
                <button className="boton" onClick={ async () => {
                    if(editando){
                        if(textoTemporal.trim() != "" && textoTemporal.trim() != tarea){
                            let {error} = await fetch(`https://api-todo-mongo-u5o8.onrender.com/tareas/actualizar/${id}/1`,{
                                method : "PUT",
                ...
                <button className="boton" onClick={ () => {
                    fetch(`https://api-todo-mongo-u5o8.onrender.com/tareas/borrar/${id}`,{
                        method : "DELETE"
                    })
                    .then(respuesta => respuesta.json())
                    .then(({error}) => {
                ...
                <button 
                    ...
                    onClick={ () => {
                        fetch(`https://api-todo-mongo-u5o8.onrender.com/tareas/actualizar/${id}/2`,{
                            method : "PUT"
                        })
                        .then(respuesta => respuesta.json())
                        .then(({error}) => {
